...
import (
	...
	soci "kubepack.dev/lib-helm/pkg/internal/oci"
	stls "kubepack.dev/lib-helm/pkg/internal/tlsutil"
...
func GetClientOpts(ctx context.Context, c client.Reader, obj *helmv1.HelmRepository, url string) (*ClientOpts, string, error) {
	hrOpts := &ClientOpts{
		GetterOpts: []helmgetter.Option{
	...
	ociRepo := obj.Spec.Type == sourcev1beta2.HelmRepositoryTypeOCI
	...
	} else if obj.Spec.Provider != sourcev1beta2.GenericOCIProvider && obj.Spec.Type == sourcev1beta2.HelmRepositoryTypeOCI && ociRepo {
...
func fetchSecret(ctx context.Context, c client.Reader, name, namespace string) (*corev1.Secret, error) {
