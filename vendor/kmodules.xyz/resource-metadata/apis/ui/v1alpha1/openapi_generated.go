...
func schema_resource_metadata_apis_ui_v1alpha1_ResourceDashboardSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kmodules.xyz/resource-metadata/apis/shared.Dashboard"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"kmodules.xyz/client-go/api/v1.ResourceID", "kmodules.xyz/resource-metadata/apis/shared.Dashboard"},
	}
}
