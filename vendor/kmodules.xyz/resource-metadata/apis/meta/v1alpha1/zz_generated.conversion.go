...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*ChartRef)(nil), (*meta.ChartRef)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ChartRef_To_meta_ChartRef(a.(*ChartRef), b.(*meta.ChartRef), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*meta.ChartRef)(nil), (*ChartRef)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_meta_ChartRef_To_v1alpha1_ChartRef(a.(*meta.ChartRef), b.(*ChartRef), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ChartRef_To_meta_ChartRef(in *ChartRef, out *meta.ChartRef, s conversion.Scope) error {
	out.URL = in.URL
	out.Name = in.Name
	return nil
}
...
func Convert_v1alpha1_ChartRef_To_meta_ChartRef(in *ChartRef, out *meta.ChartRef, s conversion.Scope) error {
	return autoConvert_v1alpha1_ChartRef_To_meta_ChartRef(in, out, s)
}

func autoConvert_meta_ChartRef_To_v1alpha1_ChartRef(in *meta.ChartRef, out *ChartRef, s conversion.Scope) error {
	out.URL = in.URL
	out.Name = in.Name
	return nil
}
...
func Convert_meta_ChartRef_To_v1alpha1_ChartRef(in *meta.ChartRef, out *ChartRef, s conversion.Scope) error {
	return autoConvert_meta_ChartRef_To_v1alpha1_ChartRef(in, out, s)
}
...
func autoConvert_v1alpha1_DeploymentParameters_To_meta_DeploymentParameters(in *DeploymentParameters, out *meta.DeploymentParameters, s conversion.Scope) error {
	...
	out.Chart = (*meta.ChartRef)(unsafe.Pointer(in.Chart))
	return nil
}
...
func autoConvert_meta_DeploymentParameters_To_v1alpha1_DeploymentParameters(in *meta.DeploymentParameters, out *DeploymentParameters, s conversion.Scope) error {
	...
	out.PlanID = in.PlanID
	out.Version = in.Version
	out.Chart = (*ChartRef)(unsafe.Pointer(in.Chart))
	return nil
}
