...
$ go run cmd/bundle-generator/main.go --name=vault-operator-bundle \
  ...
  --addons https://kubepack-testcharts.storage.googleapis.com@csi-vault-bundle@v0.3.0
...
$ go run cmd/bundle-generator/main.go --name=stash-bundle \
  ...
  --addons https://kubepack-testcharts.storage.googleapis.com@stash-mongodb-bundle@v0.9.0-rc.2
...
$ go run cmd/bundle-generator/main.go --name=kubedb-bundle \
  ...
  --addons https://kubepack-testcharts.storage.googleapis.com@stash-bundle@v0.9.0-rc.2
