...
func (c *FakePacks) Get(name string, options v1.GetOptions) (result *v1alpha1.Pack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(packsResource, name), &v1alpha1.Pack{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakePacks) List(opts v1.ListOptions) (result *v1alpha1.PackList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(packsResource, packsKind, opts), &v1alpha1.PackList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.PackList{ListMeta: obj.(*v1alpha1.PackList).ListMeta}
...
func (c *FakePacks) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(packsResource, opts))
}
...
func (c *FakePacks) Create(pack *v1alpha1.Pack) (result *v1alpha1.Pack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(packsResource, pack), &v1alpha1.Pack{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Pack), err
...
func (c *FakePacks) Update(pack *v1alpha1.Pack) (result *v1alpha1.Pack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(packsResource, pack), &v1alpha1.Pack{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Pack), err
...
func (c *FakePacks) UpdateStatus(pack *v1alpha1.Pack) (*v1alpha1.Pack, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(packsResource, "status", pack), &v1alpha1.Pack{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Pack), err
...
func (c *FakePacks) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(packsResource, name), &v1alpha1.Pack{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakePacks) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(packsResource, listOptions)
...
func (c *FakePacks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Pack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(packsResource, name, pt, data, subresources...), &v1alpha1.Pack{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Pack), err
