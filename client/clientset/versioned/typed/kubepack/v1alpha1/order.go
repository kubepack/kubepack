...
func (c *orders) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Order, err error) {
...
func (c *orders) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OrderList, err error) {
...
func (c *orders) Create(ctx context.Context, order *v1alpha1.Order, opts v1.CreateOptions) (result *v1alpha1.Order, err error) {
	result = &v1alpha1.Order{}
	err = c.client.Post().
		Resource("orders").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *orders) Update(ctx context.Context, order *v1alpha1.Order, opts v1.UpdateOptions) (result *v1alpha1.Order, err error) {
	result = &v1alpha1.Order{}
	err = c.client.Put().
		Resource("orders").
		Name(order.Name).
...
func (c *orders) UpdateStatus(ctx context.Context, order *v1alpha1.Order, opts v1.UpdateOptions) (result *v1alpha1.Order, err error) {
	result = &v1alpha1.Order{}
	err = c.client.Put().
		Resource("orders").
		Name(order.Name).
...
func (c *orders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Order, err error) {
	result = &v1alpha1.Order{}
