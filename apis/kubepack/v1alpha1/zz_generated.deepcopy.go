...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProductRef) DeepCopyInto(out *ProductRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProductRef.
func (in *ProductRef) DeepCopy() *ProductRef {
	if in == nil {
		return nil
	}
	out := new(ProductRef)
