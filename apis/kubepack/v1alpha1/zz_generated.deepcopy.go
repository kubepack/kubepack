...
func (in *ChartSelection) DeepCopyInto(out *ChartSelection) {
	*out = *in
	...
	if in.Versions != nil {
		in, out := &in.Versions, &out.Versions
		*out = make([]ChartVersionValues, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChartVersionValues) DeepCopyInto(out *ChartVersionValues) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChartVersionValues.
func (in *ChartVersionValues) DeepCopy() *ChartVersionValues {
	if in == nil {
		return nil
	}
	out := new(ChartVersionValues)
	in.DeepCopyInto(out)
	return out
}
